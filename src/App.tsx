...
import AIScribeProductPage from "./pages/AIScribeProductPage";
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="ai-scribe-product" element={<AIScribeProductPage />} />
            ...
            <Route path="medical-billing-solutions" element={<MedicalBillingSolutions />} />
          </Route>
        </Routes>
